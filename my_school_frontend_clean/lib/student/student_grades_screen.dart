// lib/screens/student/student_grades_screen.dart
...
class _StudentGradesScreenState extends State<StudentGradesScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final examsResult = await ApiService.getAllExamsByClass(widget.studentClass, widget.studentId);
      ...
      if (examsResult['success']) {
        ...
        for (var exam in exams) {
          ...
          switch(examData['type']) {
            case 'Orale': oralList.add(examData); break;
            case 'Evaluation': evaluationList.add(examData); break;
            case 'Examen': examList.add(examData); break;
            default: examList.add(examData);
          }
        }
      }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            'La note sera affichée une fois l\'évaluation corrigée.',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Notes - ${widget.studentName}'),
