...
class _AdminScheduleScreenState extends State<AdminScheduleScreen> {
  ...
  // MATIÈRES POUR ÉCOLE PRIMAIRE (les mêmes que dans AdminAddTeacherScreen)
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AdminAgendaEditScreen(
          className: className,
          subjects: _subjects, // Passage des matières
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: isComplete
                                                  ? const Color(0xFF4CAF9F).withOpacity(0.1)
                                                  : hasSchedule
                                                      ...
                                                      child: Text(
                                                        isComplete
                                                            ...
                                                            : hasSchedule
                                                                ? '📝 Agenda en cours'
                                                                : '⚠️ Agenda vide',
                                                        style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500, color: isComplete ? const Color(0xFF4CAF9F) : hasSchedule ? const Color(0xFF0288D1) : Colors.orange),
                                                      ),
                                                    ),
...
// Écran pour visualiser et modifier l'agenda d'une classe
...
class _AdminAgendaEditScreenState extends State<AdminAgendaEditScreen> {
  ...
  // Utilisation des matières passées en paramètre
  ...
  Future<void> _saveSchedule() async {
    ...
    print('Résultat sauvegarde: ${result['success']}');
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: Text(_allTimeSlots[i], style: const TextStyle(fontSize: 10, color: Colors.black87)),
                                ),
                                for (String day in _days) _buildScheduleCell(day, i),
                              ],
                            ),
                        ],
                      ),
