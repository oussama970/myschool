...
/// Écran de gestion des parents pour l'administrateur
/// Permet de visualiser la liste des parents, leurs enfants liés,
/// et de supprimer un parent
...
class _AdminParentsScreenState extends State<AdminParentsScreen> {
  ...
  /// Charge la liste des parents depuis l'API
  ...
  /// Supprime un parent après confirmation
  ...
  /// Filtre les parents selon le terme de recherche
                ...
                : _getFilteredParents().isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildParentCard(parent, children);
                        },
                      ),
          ),
        ],
  ...
  /// Affiche l'état vide (aucun parent trouvé)
  ...
  /// Construit une carte pour un parent
  Widget _buildParentCard(Map<String, dynamic> parent, List<dynamic> children) {
    return Card(
        ...
        child: Column(
          ...
          children: [
            ...
            if (parent['phoneNumber'] != null && parent['phoneNumber'].toString().isNotEmpty)
              _buildPhoneRow(parent['phoneNumber']),
  ...
  /// Construit l'en-tête de la carte parent (nom + bouton suppression)
  Widget _buildParentHeader(Map<String, dynamic> parent) {
    return Row(
  ...
  /// Construit la ligne du numéro de téléphone
  ...
  /// Construit la carte d'un enfant lié
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Classe de l'enfant (si disponible)
