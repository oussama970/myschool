...
/// Écran de profil pour l'administrateur
...
class _AdminProfileScreenState extends State<AdminProfileScreen> {
  ...
  /// Charge les données du profil administrateur depuis l'API
  ...
  /// Construit l'en-tête du profil avec l'avatar et le nom
  ...
  /// Construit le formulaire d'informations personnelles
  ...
  /// Construit la section des informations du compte
  ...
  /// Construit le bouton de changement de mot de passe
  ...
  /// Construit un champ de texte éditable
