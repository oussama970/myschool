...
/// Écran de chat étudiant permettant d'échanger des messages texte et fichiers avec un enseignant
...
class _StudentChatScreenState extends State<StudentChatScreen> {
  ...
  Future<void> _requestPermissions() async {
    if (Platform.isAndroid) {
      ...
      if (!status.isGranted) {
        print('⚠️ Permission de stockage refusée');
      }
    }
  }

  /// Charge les informations de contact de l'enseignant
    ...
    try {
      setState(() {
        _contactInfo = {
          ...
          'role': 'enseignant',
          'avatar': widget.teacherName.isNotEmpty ? widget.teacherName.substring(0, 1).toUpperCase() : '?',
        };
      });
    } catch (e) {
  ...
  /// Démarre le polling de secours pour récupérer les messages (toutes les 5 secondes)
  void _startPolling() {
  ...
  void _initSocket() {
    ...
    _socket.on('connect', (_) {
      if (!_isDisposed && mounted) {
        ...
        _socket.emit('authenticate', widget.studentId);
      }
    });
  ...
  Future<void> _loadMessages({bool showLoading = true}) async {
    ...
    try {
      final result = await ApiService.getMessages(widget.teacherId);
      ...
      if (result['success']) {
        ...
        setState(() {
          ...
          for (var msg in messages) {
            final isMe = msg['senderId'].toString() == widget.studentId;
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              ListTile(
                leading: const Icon(Icons.photo_library, color: Color(0xFF0288D1), size: 28),
              ...
              ListTile(
                leading: const Icon(Icons.insert_drive_file, color: Color(0xFF0288D1), size: 28),
            ...
            child: _isLoading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isMe = message['senderId'].toString() == widget.studentId;
