...
// Gère l'affichage de l'emploi du temps hebdomadaire d'une classe d'étudiants.
...
class _StudentScheduleScreenState extends State<StudentScheduleScreen> {
  ...
  // Initialise l'écran en lançant immédiatement le chargement des données.
  @override
  void initState() {
    super.initState();
    _loadSchedule();
  ...
  // Récupère l'emploi du temps depuis l'API et structure les données pour l'affichage.
  ...
  // Indique si un cours existe pour le créneau sélectionné (vrai si la matière n'est pas vide).
  ...
  // Renvoie le nom de la matière du créneau ciblé, ou une chaîne vide.
  ...
  // Renvoie le nom du professeur assigné au créneau ciblé.
  ...
  // Renvoie le numéro ou le nom de la salle associée au créneau ciblé.
  ...
  // Dessine l'interface utilisateur avec le sélecteur de jour et la liste des cours.
  @override
