...
import 'package:my_school_frontend/student/student_dashboard_screen.dart';
                        ...
                        child: Column(
                          children: [
                            ...
                            Align(
                              ...
                              child: TextButton(
                                onPressed: _isLoading ? null : () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ForgotPasswordScreen())),
                                style: TextButton.styleFrom(padding: EdgeInsets.zero),
                                child: const Text('Mot de passe oublié ?', style: TextStyle(fontSize: 13, color: Color(0xFF4FC3F7), fontWeight: FontWeight.w500)),
                              ),
                            ),
                            ...
                            Container(
                              ...
                              height: 55,
                              decoration: BoxDecoration(
                                gradient: const LinearGradient(colors: [Color(0xFF0288D1), Color(0xFF4FC3F7)], begin: Alignment.centerLeft, end: Alignment.centerRight),
                                borderRadius: BorderRadius.circular(15),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                TextButton(
                                  onPressed: _isLoading ? null : () => Navigator.push(context, MaterialPageRoute(builder: (context) => const RegisterScreen())),
                                  style: TextButton.styleFrom(padding: EdgeInsets.zero),
                                  child: const Text('S\'inscrire', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0xFF0288D1))),
                                ),
                              ],
                            ),
                          ],
